...
- **Indicators** — a per-indicator deep dive (formula, parameters, warmup) for
  every one of the 215 indicators; start at the
...
215 streaming-first indicators across sixteen families. Every one passes the
...
| Price Statistics     | Typical Price, Median Price, Weighted Close, Linear Regression, Linear Regression Slope, Z-Score, Linear Regression Angle, Variance, Coefficient of Variation, Skewness, Kurtosis, Standard Error, Detrended StdDev, R², Median Absolute Deviation, Autocorrelation, Hurst Exponent, Pearson Correlation, Beta, Pairwise Beta, Spearman Correlation |
...
wickra/
├── crates/
│   ├── wickra-core/         core engine + all 215 indicators
