<p align="center">
  <a href="https://wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=245" alt="Wickra — streaming-first technical indicators" width="100%"></a>
</p>
...
- **Indicators** — a per-indicator deep dive (formula, parameters, warmup) for
  every one of the 245 indicators; start at the
...
245 streaming-first indicators across eighteen families. Every one passes the
...
| Candlestick Patterns | Doji, Hammer, Inverted Hammer, Hanging Man, Shooting Star, Engulfing, Harami, Morning/Evening Star, Three White Soldiers/Black Crows, Piercing Line/Dark Cloud Cover, Marubozu, Tweezer, Spinning Top, Three Inside Up/Down, Three Outside Up/Down, Two Crows |
...
wickra/
├── crates/
│   ├── wickra-core/         core engine + all 245 indicators
