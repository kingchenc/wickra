<p align="center">
  <a href="https://wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=302" alt="Wickra — streaming-first technical indicators" width="100%"></a>
</p>
...
- **Indicators** — a per-indicator deep dive (formula, parameters, warmup) for
  every one of the 302 indicators; start at the
...
302 streaming-first indicators across nineteen families. Every one passes the
...
wickra/
├── crates/
│   ├── wickra-core/         core engine + all 302 indicators
