...
| Trend & Directional  | MACD, ADX (+DI/-DI), ADXR, Aroon, TRIX, Aroon Oscillator, Vortex, Mass Index, Choppiness Index, Vertical Horizontal Filter |
...
wickra/
├── crates/
│   ├── wickra-core/         core engine + all 72 indicators
