...
use wickra::{
    Atr, BatchExt, BollingerBands, Camarilla, Candle, ClassicPivots, DemarkPivots, Ema,
    FibonacciPivots, Indicator, MacdIndicator, Obv, Rsi, Sma, Stochastic, WilliamsFractals, Wma,
    WoodiePivots, ZigZag,
};
